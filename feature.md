...
When all works as expected, write tests in backend/api/tests.
Include tests for CRUD operations in the frontend ui, use the list view and detail view to verify the changes.
Tests should include the default cleanup.