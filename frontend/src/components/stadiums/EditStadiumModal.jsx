...
import { updateStadium } from '../../api/stadiums'
...
export default function EditStadiumModal({ stadium, onClose, onSave }) {
  ...
  const handleSave = async () => {
    setError('')
    try {
      await updateStadium(stadium.id, { ...form, cost: form.cost === '' ? null : form.cost })
      onSave()
    } catch {
